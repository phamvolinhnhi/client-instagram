...
export const CurrentChat = ({handleCreateGroup}) => {
    ...
    useEffect(() => {
        const data = {
            chatId: currentChat?.id, token
        }
        console.log('data: ',data)
        if(currentChat?.id)
            dispatch(getAllMessagesAction(data))
    },[currentChat, message.createdMessage])
                ...
                <div className="w-full h-screen relative flex flex-col text-left">
                    ...
                    <div className="footer bg-[#f0f2f5] absolute bottom-0 w-full py-3 ">
                        <div  className="flex justify-between items-center px-5">
                            ...
                            <input className="py-2 outline-none border-none bg-white rounded-md w-[100%]"
                                type="text" 
